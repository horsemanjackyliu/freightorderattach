 ...
 */
function createJobPosting([userQuery, ragResponse]) {
    const entry = {
 ...
 */
async function insertJobPosting(jobPosting) {
    try {
 ...
 * @returns {string} - The success message.
 */
async function deleteJobPosting(withID) {
    try {
 ...
 * @returns {string} - The success message.
 */
async function deleteJobPostings() {
    try {
 ...
 */
function createEmbeddingEntries([embeddings, splitDocuments]) {
 ...
 * @returns {string} - The success message.
 */
async function insertVectorEmbeddings(embeddingEntries) {
    try {
 ...
 * @returns {string} - The success message.
 */
async function deleteVectorEmbeddings() {
    try {
...
module.exports = { createJobPosting, deleteJobPosting, deleteJobPostings, insertJobPosting, createEmbeddingEntries, insertVectorEmbeddings, deleteVectorEmbeddings };