/* checksum : a32d10d80e7a1b7111f60ff8ed32ee81 */
@cds.external                                       : true
...
service CE_FREIGHTORDER_0001 {
    ...
    entity FreightOrder {
        ...
        key TransportationOrderUUID        : UUID not null;
            ...
            _FreightOrderBusinessPartner   : Composition of many FreightOrderBusinessPartner {};

            @Common.Composition: true
            _FreightOrderCharge            : Composition of one FreightOrderCharge {};

            @Common.Composition: true
            _FreightOrderDocumentReference : Composition of many FreightOrderDocumentReference {};

            @Common.Composition: true
            _FreightOrderEvent             : Composition of many FreightOrderEvent {};

            @Common.Composition: true
            _FreightOrderItem              : Composition of many FreightOrderItem {};

            @Common.Composition: true
            _FreightOrderStop              : Composition of many FreightOrderStop {};

            @Common.Composition: true
            _FrtOrdMainBPAddrDfltRprstn    : Composition of many FrtOrdMainBPAddrDfltRprstn {};
        ...
        action CreateFreightOrder(_it : many $self not null,
                                  ...
                                  TransportationOrder : String(20) not null default ' ')            returns FreightOrder not null;
        action CreateForDelivery(_it : many $self not null,
                                 ...
                                 @Common.DocumentationRef: 'urn:sap-com:documentation:key?=type=DE&id=%2FSCMTMS%2FTOR_TYPE'
                                 TransportationOrderType : String(4) not null,
                                 _FreightBookingItems : many D_FreightOrdCrteForDelivItmP not null) returns many FreightOrder not null;
        ...
        action CreateForPickup(_it : many $self not null,
                               ...
                               @Common.DocumentationRef: 'urn:sap-com:documentation:key?=type=DE&id=%2FSCMTMS%2FTOR_TYPE'
                               TransportationOrderType : String(4) not null,
                               _FreightBookingItems : many D_FreightOrderCrteForPkupItmP not null)  returns many FreightOrder not null;
    ...
    entity FreightOrderBusinessPartner {
        ...
        key TransportationOrderBusPartUUID : UUID not null;
            ...
            SAP__Messages                  : many SAP__Message not null;
            _FreightOrder                  : Association to one FreightOrder {};

            @Common.Composition: true
            _FrtOrdBPAddrDfltRprstn        : Composition of one FrtOrdBPAddrDfltRprstn {};
    };
    ...
    entity FreightOrderCharge {
        ...
        key TransportationChargesObjUUID   : UUID not null;
            ...
            @Common.Composition: true
            _FreightOrderChargeItem        : Composition of many FreightOrderChargeItem {};
    };
    ...
    entity FreightOrderChargeItem {
        ...
        key TranspChargeItemUUID          : UUID not null;
            ...
            SAP__Messages                 : many SAP__Message not null;
            _FreightOrder                 : Association to one FreightOrder {};
            _FreightOrderCharge           : Association to one FreightOrderCharge {};

            @Common.Composition: true
            _FrtOrdChrgElement            : Composition of many FrtOrdChrgElement {};

            @Common.Composition: true
            _FrtOrdChrgItmExchRate        : Composition of many FrtOrdChrgItmExchRate {};
    };
    ...
    entity FreightOrderItem {
        ...
        key TransportationOrderItemUUID    : UUID not null;
            ...
            @Common.Composition: true
            _FreightOrderItemCommodityCode : Composition of many FreightOrderItemCommodityCode {};

            @Common.Composition: true
            _FreightOrderItemDocRef        : Composition of many FreightOrderItemDocRef {};

            @Common.Composition: true
            _FreightOrderItemSeal          : Composition of many FreightOrderItemSeal {};

            @Common.Composition: true
            _FrtOrdItmMainBPAddrDfltRprstn : Composition of many FrtOrdItmMainBPAddrDfltRprstn {};
    ...
    entity FreightOrderItemCommodityCode {
        ...
        key TranspOrdItemCommodityCodeUUID : UUID not null;
            ...
            _FreightOrder                  : Association to one FreightOrder {};
            _FreightOrderItem              : Association to one FreightOrderItem {};
    };
    ...
    entity FreightOrderStage {
        ...
        key TransportationOrderStageUUID   : UUID not null;
            ...
            _FreightOrder                  : Association to one FreightOrder {};
            _FreightOrderStop              : Association to one FreightOrderStop {};

            @Common.Composition: true
            _FrtOrdStageBPAddrDfltRprstn   : Composition of many FrtOrdStgeBPAddrDfltRprstn {};
    ...
    entity FreightOrderStop {
        ...
        key TransportationOrderStopUUID   : UUID not null;
            ...
            @Common.Composition: true
            _FreightOrderStage            : Composition of many FreightOrderStage {};

            @Common.Composition: true
            _FrtOrdStopLocAddrDfltRprstn  : Composition of one FrtOrdStopLocAddrDfltRprstn {};
    };
    ...
    entity FrtOrdBPAddrAddlRprstn {
        ...
        key AddressRepresentationCode      : String(1) not null;
            ...
            _FreightOrder                  : Association to one FreightOrder {};
            _FrtOrdBPAddrDfltRprstn        : Association to one FrtOrdBPAddrDfltRprstn {};
    };
    ...
    entity FrtOrdBPAddrDfltRprstn {
        ...
        key TransportationOrderBusPartUUID : UUID not null;
            ...
            _FreightOrder                  : Association to one FreightOrder {};
            _FreightOrderBusinessPartner   : Association to one FreightOrderBusinessPartner {};

            @Common.Composition: true
            _FrtOrdBPAddrAddlRprstn        : Composition of many FrtOrdBPAddrAddlRprstn {};
    };
    ...
    entity FrtOrdChrgCalcBase {
        ...
        key TranspChrgCalcBaseUUID      : UUID not null;
            ...
            SAP__Messages               : many SAP__Message not null;
            _FreightOrder               : Association to one FreightOrder {};
            _FrtOrdChrgElement          : Association to one FrtOrdChrgElement {};
    };
    ...
    entity FrtOrdChrgElement {
        ...
        key TranspChargeItemElementUUID    : UUID not null;
            ...
            SAP__Messages                  : many SAP__Message not null;
            _FreightOrder                  : Association to one FreightOrder {};
            _FreightOrderChargeItem        : Association to one FreightOrderChargeItem {};

            @Common.Composition: true
            _FrtOrdChrgCalcBase            : Composition of many FrtOrdChrgCalcBase {};

            @Common.Composition: true
            _FrtOrdChrgCalcRule            : Composition of many FrtOrdChrgCalcRule {};

            @Common.Composition: true
            _FrtOrdChrgElmntExchRate       : Composition of many FrtOrdChrgElmntExchRate {};
    };
    ...
    entity FrtOrdItmMainBPAddrAddlRprstn {
        ...
        key AddressRepresentationCode      : String(1) not null;
            ...
            Region                         : String(3) not null;
            _FreightOrder                  : Association to one FreightOrder {};
            _FrtOrdItmMainBPAddrDfltRprstn : Association to one FrtOrdItmMainBPAddrDfltRprstn {};
    };
    ...
    entity FrtOrdItmMainBPAddrDfltRprstn {
        ...
        key TranspOrdBizPartnerFunction    : String(2) not null;
            ...
            @Common.Composition: true
            _FrtOrdItmMainBPAddrAddlRprstn : Composition of many FrtOrdItmMainBPAddrAddlRprstn {};
    };
    ...
    entity FrtOrdMainBPAddrAddlRprstn {
        ...
        key AddressRepresentationCode   : String(1) not null;
            ...
            Region                      : String(3) not null;
            _FreightOrder               : Association to one FreightOrder {};
            _FrtOrdMainBPAddrDfltRprstn : Association to one FrtOrdMainBPAddrDfltRprstn {};
    };
    ...
    entity FrtOrdMainBPAddrDfltRprstn {
        ...
        key TranspOrdBizPartnerFunction    : String(2) not null;
            ...
            @Common.Composition: true
            _FrtOrdMainBPAddrAddlRprstn    : Composition of many FrtOrdMainBPAddrAddlRprstn {};
    };
    ...
    entity FrtOrdStgeBPAddrAddlRprstn {
        ...
        key AddressRepresentationCode    : String(1) not null;
            ...
            Region                       : String(3) not null;
            _FreightOrder                : Association to one FreightOrder {};
            _FrtOrdStgeBPAddrDfltRprstn  : Association to one FrtOrdStgeBPAddrDfltRprstn {};
    };
    ...
    entity FrtOrdStgeBPAddrDfltRprstn {
        ...
        key TranspOrdBizPartnerFunction    : String(2) not null;
            ...
            InternationalFaxNumber         : String(30) not null;
            _FreightOrder                  : Association to one FreightOrder {};
            _FreightOrderStage             : Association to one FreightOrderStage {};

            @Common.Composition: true
            _FrtOrdStgeBPAddrAddlRprstn    : Composition of many FrtOrdStgeBPAddrAddlRprstn {};
    };
    ...
    entity FrtOrdStopLocAddrAddlRprstn {
        ...
        key AddressRepresentationCode    : String(1) not null;
            ...
            Region                       : String(3) not null;
            _FreightOrder                : Association to one FreightOrder {};
            _FrtOrdStopLocAddrDfltRprstn : Association to one FrtOrdStopLocAddrDfltRprstn {};
    };
    ...
    entity FrtOrdStopLocAddrDfltRprstn {
        ...
        key TransportationOrderStopUUID  : UUID not null;
            ...
            @Common.Composition: true
            _FrtOrdStopLocAddrAddlRprstn : Composition of many FrtOrdStopLocAddrAddlRprstn {};
    };
};
